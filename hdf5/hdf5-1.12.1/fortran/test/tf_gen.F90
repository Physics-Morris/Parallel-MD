...
!DEC$endif
  SUBROUTINE verify_integer_kind_1(string,value,correct_value,total_error)
    IMPLICIT NONE
...
!DEC$endif
  SUBROUTINE verify_integer_kind_2(string,value,correct_value,total_error)
    IMPLICIT NONE
    CHARACTER(LEN=*) :: string
...
!DEC$endif
  SUBROUTINE verify_integer_kind_4(string,value,correct_value,total_error)
    IMPLICIT NONE
    CHARACTER(LEN=*) :: string
...
!DEC$endif
  SUBROUTINE verify_integer_kind_8(string,value,correct_value,total_error)
    IMPLICIT NONE
    CHARACTER(LEN=*) :: string
...
!DEC$endif
  SUBROUTINE verify_integer_kind_16(string,value,correct_value,total_error)
    IMPLICIT NONE
    CHARACTER(LEN=*) :: string
...
!DEC$endif
  SUBROUTINE verify_real_kind_4(string,value,correct_value,total_error)
    IMPLICIT NONE
    CHARACTER(LEN=*) :: string
...
!DEC$endif
  SUBROUTINE verify_real_kind_8(string,value,correct_value,total_error)
    IMPLICIT NONE
    CHARACTER(LEN=*) :: string
...
!DEC$endif
  SUBROUTINE verify_real_kind_10(string,value,correct_value,total_error)
    IMPLICIT NONE
    CHARACTER(LEN=*) :: string
...
!DEC$endif
  SUBROUTINE verify_real_kind_16(string,value,correct_value,total_error)
    IMPLICIT NONE
    CHARACTER(LEN=*) :: string
...
!DEC$endif
  SUBROUTINE verify_character(string,value,correct_value,total_error)
    IMPLICIT NONE
    CHARACTER*(*) :: string
...
!DEC$endif
  SUBROUTINE verify_logical(string,value,correct_value,total_error)
    IMPLICIT NONE
    CHARACTER(LEN=*) :: string
